...
internal static class HelpCommand
{
    ...
    private static void ShowGeneralHelp()
    {
        ...
        Console.WriteLine("  ignixa tenants     - List all active tenants on the server");
        ...
        Console.WriteLine("  ignixa job list --tenant 1");
