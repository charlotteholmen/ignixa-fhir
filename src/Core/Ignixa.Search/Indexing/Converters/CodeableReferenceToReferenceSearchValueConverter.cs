...
/// </summary>
public class CodeableReferenceToReferenceSearchValueConverter : FhirElementToSearchValueConverter<ReferenceSearchValue>
{
    ...
    {
        var reference = value.Scalar("reference") as IElement;
