...
/// </summary>
public interface IElementToSearchValueConverterManager
{
    /// <summary>
    ...
    bool TryGetConverter(string fhirType, Type searchValueType, out IElementToSearchValueConverter converter);
}
