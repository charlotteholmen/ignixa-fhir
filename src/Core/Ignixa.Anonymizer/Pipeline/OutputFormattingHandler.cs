...
/// </summary>
internal sealed class OutputFormattingHandler(ILogger<OutputFormattingHandler> logger, IValidationSchemaResolver schemaResolver) : AnonymizerPipelineHandler
{
