...
/// <summary>
/// Represents the final result of a bulk patch job.
/// </summary>
public record BulkPatchJobResult
{
    /// <summary>
    ...
    /// <summary>
    /// Details about resources that failed to patch.
    /// </summary>
    public required IReadOnlyList<BulkPatchIssue> Issues { get; init; }
}
