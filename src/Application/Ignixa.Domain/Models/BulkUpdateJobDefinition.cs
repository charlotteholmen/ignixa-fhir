...
/// <summary>
/// Immutable bulk update job definition (input parameters) for use with BackgroundJob&lt;BulkUpdateJobDefinition&gt;.
/// Represents the configuration of a FHIR bulk update operation.
/// TenantId is stored here (in the payload), not as a BackgroundJob property.
/// </summary>
public class BulkUpdateJobDefinition : IJobDefinition
{
    /// <summary>
