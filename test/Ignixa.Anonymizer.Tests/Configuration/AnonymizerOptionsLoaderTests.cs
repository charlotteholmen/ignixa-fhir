...
namespace Ignixa.Anonymizer.Tests.Configuration;

public class AnonymizerOptionsLoaderTests
{
    [Fact]
    public void GivenNonExistentFile_WhenLoadFromFile_ThenReturnsConfigNotFound()
    {
        // Act
        var result = AnonymizerOptionsLoader.LoadFromFile("does-not-exist.json");
    ...
    public void GivenValidConfigJson_WhenLoadFromJson_ThenReturnsOptions()
    {
        ...
        // Act
        var result = AnonymizerOptionsLoader.LoadFromJson(json);
    ...
    {
        // Act
        var result = AnonymizerOptionsLoader.LoadFromJson("{not valid json}");
    ...
    {
        // Act
        var result = AnonymizerOptionsLoader.LoadFromJson("null");
