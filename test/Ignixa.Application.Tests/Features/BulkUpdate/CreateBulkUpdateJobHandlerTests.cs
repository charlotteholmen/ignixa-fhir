...
public class CreateBulkUpdateJobHandlerTests
{
    private readonly FhirPatchParametersParser _patchParametersParser;

    public CreateBulkUpdateJobHandlerTests()
    {
    ...
    [Fact]
    public void GivenCreateBulkUpdateJobCommand_WhenCreating_ThenPropertiesSet()
    {
        // Arrange
        var parametersJson = CreateValidReplaceParametersJson();
        var patchParameters = JsonSourceNodeFactory.Parse<ParametersJsonNode>(parametersJson);
    ...
    [Fact]
    public void GivenCreateBulkUpdateJobCommand_WhenResourceTypeNull_ThenAllResourceTypesTargeted()
    {
        // Arrange
        var parametersJson = CreateValidReplaceParametersJson();
        var patchParameters = JsonSourceNodeFactory.Parse<ParametersJsonNode>(parametersJson);
    ...
    [Fact]
    public void GivenCreateBulkUpdateJobResult_WhenCreating_ThenAllPropertiesSet()
    {
        // Arrange & Act
        var result = new CreateBulkUpdateJobResult
        {
            JobId = "job-123",
            Status = "Queued",
    ...
    [Fact]
    public void GivenBulkUpdateJobDefinition_WhenConvertingOperations_ThenCorrectTypeMapping()
    {
