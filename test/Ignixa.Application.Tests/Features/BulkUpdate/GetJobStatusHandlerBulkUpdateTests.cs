...
public class GetJobStatusHandlerBulkUpdateTests
{
    [Fact]
    public void GivenBulkUpdateJobProgress_WhenSerializing_ThenRoundTripsCorrectly()
    {
        // Arrange
        ...
        var deserialized = JsonSerializer.Deserialize<BulkUpdateJobProgress>(json);
    ...
    [Fact]
    public void GivenBulkUpdateJobResult_WhenSerializing_ThenRoundTripsCorrectly()
    {
        // Arrange
        var result = new BulkUpdateJobResult
        {
            ...
            {
                new BulkUpdateIssue("Patient", "patient-1", "Error 1")
            }
        };

        // Act
        var json = JsonSerializer.Serialize(result);
        var deserialized = JsonSerializer.Deserialize<BulkUpdateJobResult>(json);
    ...
    public void GivenGetJobStatusResult_WhenCreating_ThenAllPropertiesSet()
    {
        ...
        result.JobType.ShouldBe("BulkUpdate");
    ...
    public void GivenGetJobStatusQuery_WhenCreating_ThenPropertiesSet()
    {
        ...
        query.JobType.ShouldBe("BulkUpdate");
        query.TenantId.ShouldBe(1);
    }

    [Fact]
    public void GivenBulkUpdateOrchestrationOutput_WhenSerializing_ThenRoundTripsCorrectly()
    {
        // Arrange
        var output = new BulkUpdateOrchestrationOutput
        {
            JobId = "job-123",
            Status = "Completed",
            TotalProcessed = 1000,
            ...
            Issues = new List<BulkUpdateIssue>
            {
                new BulkUpdateIssue("Patient", "patient-123", "Failed to patch")
            }
        };

        // Act
        var json = JsonSerializer.Serialize(output);
        var deserialized = JsonSerializer.Deserialize<BulkUpdateOrchestrationOutput>(json);
    ...
    [Fact]
    public void GivenBackgroundJobWithBulkUpdateDefinition_WhenCreating_ThenDefinitionAccessible()
    {
        // Arrange
    ...
    public void GivenBackgroundJobWithProgress_WhenSettingProgress_ThenProgressAccessible()
    {
        ...
        var deserializedProgress = JsonSerializer.Deserialize<BulkUpdateJobProgress>(job.Progress.ToJsonString());
    ...
    [Fact]
    public void GivenBulkUpdateJobDefinition_WhenTenantIdSet_ThenImplementsIJobDefinition()
    {
        // Arrange
        var definition = new BulkUpdateJobDefinition
        {
