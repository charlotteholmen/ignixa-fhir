...
public class BulkPatchDomainModelTests
{
    [Fact]
    public void GivenBulkPatchJobDefinition_WhenCreating_ThenRequiredFieldsAreSet()
    {
        // Arrange & Act
    ...
    [Fact]
    public void GivenBulkPatchJobDefinition_WhenResourceTypeNull_ThenAllResourceTypesTargeted()
    {
        // Arrange & Act
        var definition = new BulkPatchJobDefinition
        {
    ...
    [Fact]
    public void GivenBulkPatchOperationDefinition_WhenReplaceType_ThenPathAndValueRequired()
    {
        // Arrange & Act
        var operation = new BulkPatchOperationDefinition
        {
            Type = "replace",
    ...
    [Fact]
    public void GivenBulkPatchOperationDefinition_WhenUpsertType_ThenNameCanBeProvided()
    {
        // Arrange & Act
        var operation = new BulkPatchOperationDefinition
        {
    ...
    [Fact]
    public void GivenBulkPatchJobProgress_WhenCreating_ThenAllFieldsSet()
    {
        // Arrange & Act
    ...
    [Fact]
    public void GivenBulkPatchJobProgress_WhenSumCounts_ThenEqualsProcessed()
    {
        // Arrange
        var progress = new BulkPatchJobProgress
        {
    ...
    [Fact]
    public void GivenBulkPatchJobResult_WhenCreating_ThenCountDictionariesAreSet()
    {
        // Arrange & Act
        var result = new BulkPatchJobResult
        {
            ...
            {
                new BulkPatchIssue("Patient", "patient-123", "Invalid path")
            }
        };
    ...
    [Fact]
    public void GivenBulkPatchJobResult_WhenCalculatingTotals_ThenSumsAreCorrect()
    {
        // Arrange
        var result = new BulkPatchJobResult
        {
    ...
    [Fact]
    public void GivenBulkPatchIssue_WhenCreating_ThenRecordPropertiesSet()
    {
        // Arrange & Act
        var issue = new BulkPatchIssue(
            ResourceType: "Patient",
    ...
    [Fact]
    public void GivenBulkPatchIssue_WhenComparing_ThenValueEqualityUsed()
    {
        // Arrange
        var issue1 = new BulkPatchIssue("Patient", "patient-123", "Error message");
        var issue2 = new BulkPatchIssue("Patient", "patient-123", "Error message");
        var issue3 = new BulkPatchIssue("Patient", "patient-456", "Error message");
    ...
    [Fact]
    public void GivenBulkPatchOperationDefinition_WhenValueIsComplexObject_ThenStoredCorrectly()
    {
        // Arrange
    ...
    [Fact]
    public void GivenBulkPatchJobDefinition_WhenMultipleOperations_ThenAllPreserved()
    {
        // Arrange & Act
        var definition = new BulkPatchJobDefinition
        {
    ...
    [Fact]
    public void GivenBackgroundJobType_WhenBulkPatch_ThenValueIs5()
    {
        // Assert
        ((int)BackgroundJobType.BulkPatch).ShouldBe(5);
    }

    [Fact]
    public void GivenBulkPatchJobProgress_WhenNoCurrentResourceType_ThenNullable()
    {
        // Arrange & Act
        var progress = new BulkPatchJobProgress
        {
